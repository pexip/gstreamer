 ...
 * MT safe.
 *
 * Returns: A filter that can be passed to @gst_check_log_filter_remove.
 **/
GstCheckLogFilter *
 ...
 * @filter: Filter returned by @gst_check_log_filter_add
 *
 ...
 **/
void
gst_check_log_filter_remove (GstCheckLogFilter * filter)
{
  g_mutex_lock (&_gst_check_log_filters_mutex);
  g_queue_remove (&_gst_check_log_filters, filter);
  gst_check_log_filter_free (filter);
  g_mutex_unlock (&_gst_check_log_filters_mutex);
}
...
gst_check_log_filter_clear (void)
{
  ...
  g_queue_foreach (&_gst_check_log_filters,
      (GFunc) gst_check_log_filter_free, NULL);
...
static void
gst_check_log_filter_apply (GstCheckLogFilter * filter,
    LogFilterApplyData * data)
{
  if (gst_check_log_filter_match (filter, data->domain, data->level,
          data->message)) {
    if (filter->func)
    ...
    GLogLevelFlags log_level, const gchar * message)
{
  ...
  g_mutex_lock (&_gst_check_log_filters_mutex);
  g_queue_foreach (&_gst_check_log_filters, (GFunc) gst_check_log_filter_apply,
      &data);
  g_mutex_unlock (&_gst_check_log_filters_mutex);
