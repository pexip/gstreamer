 ...
 */
GParamSpec *
gst_param_spec_int_range (const gchar * name, const gchar * nick,
    const gchar * blurb, gint min_min, gint min_max, gint min_step,
    gint max_min, gint max_max, gint max_step, gint def_min, gint def_max,
    gint def_step, GParamFlags flags)
{
  ...
  irspec =
      g_param_spec_internal (GST_TYPE_PARAM_INT_RANGE, name, nick, blurb,
      flags);
