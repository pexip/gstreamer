...
static gboolean
pad_foreach_func (G_GNUC_UNUSED GstElement *e, GstPad *pad, gpointer user_data)
{
...
static gboolean
add_srcpad_deadlock_activate_mode (GstPad *pad, G_GNUC_UNUSED GstObject *parent,
    G_GNUC_UNUSED GstPadMode mode, gboolean active)
{
  if (active)
