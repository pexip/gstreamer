...
static GQuark quark_rfc7273_active;
...
gst_rtp_jitter_buffer_class_init (GstRtpJitterBufferClass * klass)
{
  ...
  quark_rfc7273_active = g_quark_from_static_string ("rfc7273-active");
...
gst_rtp_jitter_buffer_create_stats (GstRtpJitterBuffer * jbuf)
{
  ...
  s = gst_structure_new_id (quark_application_x_rtp_jitterbuffer_stats,
      ...
      quark_rtx_rtt, G_TYPE_UINT64, priv->avg_rtx_rtt,
      quark_rfc7273_active, G_TYPE_BOOLEAN, rfc7273_active, NULL);
  JBUF_UNLOCK (priv);
