...
gst_vulkan_window_ios_create_window (GstVulkanWindowIos * window_ios)
{
  ...
  _gst_vulkan_ios_invoke_on_main ((GstVulkanWindowFunc) _create_window,
...
void
_gst_vulkan_ios_invoke_on_main (GstVulkanWindowFunc func, gpointer data, GDestroyNotify notify)
{
